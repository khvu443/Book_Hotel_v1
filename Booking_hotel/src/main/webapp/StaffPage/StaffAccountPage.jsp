...
<html lang="en">
    ...
    <body id="page-top">
                                    ...
                                    <div class="card-header py-3">
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4  d-flex justify-content-end" >
                                                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#add-staff">Add Staff</button>
                                            </div>
                                        </div>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${staff}" var="s">
                                                        <tr>
                                                            ...
                                                            <td>${s.username}</td>
                                                            <td>${s.fullname}</td>
                                                            <c:if test="${s.getStatusAcc() == 1}">
                                                                <td><i class="fa-solid fa-user-check text-success"></i></td>
                                                            </c:if>
                                                            <c:if test="${s.getStatusAcc() == 0}">
                                                                <td><i class="fa-solid fa-user-large-slash text-danger"></i></td>
                                                            </c:if>

                                                            <c:if test="${s.getStatusAcc() == 0}">
                                                                <td>
                                                                    <a href="StaffChangeStatus?id=${s.getID()}&status=1" class="text-decoration-none text-success"><i class="fa-duotone fa-check"></i></a>
                                                                </td>
                                                            </c:if>
                                                            <c:if test="${s.getStatusAcc() == 1}">
                                                                <td><a href="StaffChangeStatus?id=${s.getID()}&status=0" class="text-decoration-none text-danger"><i class="fa-solid fa-xmark"></i></a></td>
                                                                    </c:if>
                                                                </c:forEach>
                                                </tbody>
                                            </table>
        ...
        <!-- Modal -->
        <div class="modal fade" id="add-staff" tabindex="-1" aria-labelledby="add-staff" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" action="StaffAddAccount" method="POST">
                            <div class="col-md-6">
